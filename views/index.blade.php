...
<ul class="nav nav-tabs" role="tablist" style="margin-bottom: 15px;">
    ...
    <li class="nav-item">
        <a class="nav-link" onclick="jsListFile()" href="#listFile" data-toggle="tab">
            <i class="fas fa-folder"></i> {{ __("Dosyalar") }}
        </a>
    </li>
</ul>
...
<div class="tab-content">
    ...
    <div id="listFile" class="tab-pane">
        @include('listfile.main')
    </div>
</div>
@endsection